...
test.describe("System health issue dialog", () => {
  test("keeps issue cards scrolling while the dialog shell and final Fix stay reachable", async ({
    testPage,
    backend,
  }) => {
